  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/3196887/pexels-photo-3196887.jpeg?auto=compress&cs=tinysrgb&w=1920')] bg-cover bg-center"></div>
      ...
      >
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
          ...
          <span className="block bg-gradient-to-r from-[#00f0ff] via-[#ff00c8] to-[#9c27b0] text-transparent bg-clip-text mt-2">Future of Innovation</span>
        </h1>
